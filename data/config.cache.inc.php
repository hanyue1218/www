...
$cfg_indexname = '主页';
$cfg_webname = '（自适应手机版）响应式汽车车载仪表类网站织梦模板 HTML5汽车配件零部件网站源码下载 - AB模版网 - Www.AdminBuy.Cn';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; Ab模版网工作室 Www.AdminBuy.Cn 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '汽车配件零部件网站模版,响应式车载载仪网站源码';
$cfg_description = '（自适应手机版）响应式汽车车载仪表类网站织梦模板 HTML5汽车配件零部件网站源码下载 - AB模版网 - Www.AdminBuy.Cn';
